...
def build_Unet(
    ...
    c1 = Conv2D(n_c_fltr, (3, 3), activation='softplus', padding='same', name='Block1_Conv1') (inputs) # (None, 56, 120, 128)
    c1 = Conv2D(n_c_fltr*2, (3, 3), activation='softplus', padding='same', name='Block1_Conv2') (c1) # (None, 56, 120, 256)
    p1 = MaxPooling2D((2, 2), name='Block1_MaxPool', padding='same') (c1) # (None, 28, 60, 256)

    c2 = Conv2D(n_c_fltr*2, (3, 3), activation='softplus', padding='same', name='Block2_Conv1') (p1) # (None, 28, 60, 256)
    c2 = Conv2D(n_c_fltr*4, (3, 3), activation='softplus', padding='same', name='Block2_Conv2') (c2) # (None, 28, 60, 512)
    p2 = MaxPooling2D((2, 2), name='Block2_MaxPool', padding='same') (c2) # (None, 14, 30, 512)

    c3 = Conv2D(n_c_fltr*4, (3, 3), activation='softplus', padding='same', name='Block3_Conv1') (p2) # (None, 14, 30, 512)
    c3 = Conv2D(n_c_fltr*8, (3, 3), activation='softplus', padding='same', name='Block3_Conv2') (c3) # (None, 14, 30, 1024)
    p3 = MaxPooling2D((2, 2), name='Block3_MaxPool', padding='same') (c3) # (None, 7, 15, 1024)

    c4 = Conv2D(n_c_fltr*8, (3, 3), activation='softplus', padding='same', name='Block4_Conv1') (p3) # (None, 7, 15, 1024)
    c4 = Conv2D(n_c_fltr*8, (3, 3), activation='softplus', padding='same', name='Block4_Conv2') (c4) # (None, 7, 15, 1024)
    ...
    resh = Reshape( (7, 15, n_c_fltr*8) , name='Block5_Reshape') (lstm) # (None, 7, 15, 1024)
    ...
    u5_cropped = Lambda(lambda x: tf.slice(x, [0, 0, 0, 0], [-1, 14, 30, -1]), output_shape=(14, 30, n_c_fltr*4))(u5) # (None, 14, 30, 512)
    ...
    c2_cropped = Lambda(lambda x: tf.slice(x, [0, 7, 15, 0], [-1, 14, 30, -1]), output_shape=(14, 30, n_c_fltr*4))(c2) # (None, 14, 30, 512)
    ...
    c5 = Conv2D(n_c_fltr*2, (3, 3), activation='softplus', padding='same', name='Block5_Conv1') (u5_comb) # (None, 14, 30, 256)
    c5 = Conv2D(n_c_fltr*2, (3, 3), activation='softplus', padding='same', name='Block5_Conv2') (c5) # (None, 14, 30, 256)
    ...
    c6 = Conv2D(n_c_fltr, (3, 3), activation='softplus', padding='same', name='Block6_Conv1') (u6_comb) # (None, 28, 60, 128)
    c6 = Conv2D(n_c_fltr, (3, 3), activation='softplus', padding='same', name='Block6_Conv2') (c6) # (None, 28, 60, 128)
    ...
    c7 = Conv2D(n_c_fltr//2, (3, 3), activation='softplus', padding='same', name='Block7_Conv1') (u7_comb) # (None, 56, 120, 64)
    c7 = Conv2D(n_c_fltr//2, (3, 3), activation='softplus', padding='same', name='Block7_Conv2') (c7) # (None, 56, 120, 64)
