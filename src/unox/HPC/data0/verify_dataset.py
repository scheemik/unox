...
def fuzzy_coord_match(
    ...
    """ Return standard coordinate name for given fuzzy match.
        ...
        Take in a coordinate name which may be a variation of standard coordinate names (e.g., 'lat', 'latitude', 'Latitude') and returns the standard coordinate name ('lat', 'lon', 'time') for latitude, longitude, and time. 
        Also returns the dummy 'number' coordinate from ERA5 data.
