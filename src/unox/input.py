    ...
    **kwargs,
    ...
    """ Make an input file for the Unet model.
        ...
        stage_2_cutoff : `int`, optional
            ...
            For example, if `stage_2_cutoff` is 2013, stage 2 will be generated for 2014 and later.
    ...
    # Check whether there are insitu attributes
    if not 'attrs_insitu' in ds_dictionary[key].attrs:
        # Add a note saying no insitu data were used
        attr_dictionary['ds_insitu'] = "No insitu data were used for this input file."
    ...
    print(f"Saving input file to netcdf")
...
def add_tm1_var(
    ...
    # Drop the first day, as the t-1 variable will have null values on that day
    xr_dataset = xr_dataset.drop_isel(time=0)
    # try:
